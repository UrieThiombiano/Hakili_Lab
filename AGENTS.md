# AGENTS.md — Hakili Lab AI Assisted Correction
...
- Transcription multimodale (Gemini 2.5 Flash / Codex Sonnet)
- Correction IA binaire 0/1 (DeepSeek V3 / Codex) — devient une "proposition" soumise à l'enseignant
- RAG curriculum (121 leçons 6e→3e, `CurriculumRetriever`)
- Diagnostic (`DiagnosticResult`, `CompetencyGap`)
- Remédiation (Mistral Small / Codex)
...
|---|---|---|
| Transcription | Gemini 2.5 Flash | Codex Sonnet 4.6 |
| Correction (proposition) | DeepSeek V3 | Codex Sonnet 4.6 |
| Diagnostic | Codex Opus 4.7 | — |
| Remédiation | Mistral Small | Codex Sonnet 4.6 |
| Extraction barème/énoncé | Codex Sonnet 4.6 | — |
